...
>
> A weekly cross-source dossier per regulated vertical. Each claim mapped to a primary source. White-labeled for the firms who already publish to their own clients.
...
### Headline tier
- *Footnoted intelligence, resellable by your firm — without the rewrite.* (hero)
- *One body. Two mastheads. Same footnotes.* (reseller section)
...
### Body tier
- The methodology paragraph: sourcing, dedupe, footnote, ship.
- The reseller scope statement: what you change, what we hold.
- The objection-handling bullets in pricing: refund, sample, crypto-only, net-30.

### Proof tier (Wave 3)
- Named resellers (with their permission) on the partnership page.
- Source-list page per vertical, public.
- Changelog of editorial decisions, public.
- Sample dossier excerpt embedded in hero (already in Wave 2).
...
5. **&ldquo;Leaks we declined&rdquo; (5%).** A rare format: a public note on a leaked document we received and chose not to publish, with the reasons. High-trust signal.

## Channel deployment (see `06-sales-channels.md`)

The marketing strategy is tightly coupled to the channels in `06-sales-channels.md`. Marketing&rsquo;s job here is to define what gets said where; sales channels define the mechanics.
...
## Year 1 calendar (high level)

| Month | Marketing emphasis |
|---|---|
| 1 | Public launch. Methodology essay on Substack. 30 named-account direct outreach starts. |
| 2 | Sample-dossier campaign. First three Single subscribers. |
| 3 | First &ldquo;dedupe of the fortnight&rdquo; LinkedIn post. First Bundle subscriber. |
| 4 | First Reseller-license deal. Co-authored case study drafted. |
| 5 | Source-list per vertical published. Vertical-roadmap post. |
| 6 | Mid-year methodology review. Conference talk in Brussels. |
| 7 | Second Reseller deal. Edits to white-label scope based on feedback. |
| 8 | First &ldquo;leak we declined&rdquo; post. |
| 9 | Q3 roadmap post. New vertical announced (space-launch / orbital). |
| 10 | Holiday-season editorial calendar (lighter cadence, not paused). |
| 11 | Year-end reflections from each vertical. |
| 12 | Year 1 retrospective post. Subscriber + reseller counts published. |

## Success metrics (marketing-specific)

- Sample-dossier requests per month: 25 by month 6.
